          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
              ...
              <li class="nav-item active">
                <a class="nav-link" href="cuahang.jsp"> Cửa Hàng <span class="sr-only">(current)</span></a>
              </li>
             <li class="nav-item">
        ...
        <div class="col-sm-6 col-xl-3">
          ...
          <div class="box">
            <a href="">
              ...
              <div class="new"> <a href="giohangController?Mamp=<%=s.getMamp()%>&thumbnail=<%=s.getImg()%>&title=<%=s.getTen()%>&discount=<%=s.getGia()%>" style="width: 100%; border-radius: 0px;">
