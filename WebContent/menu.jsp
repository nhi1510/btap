...
%>
  <div class="hero_area">
    ...
    <header class="header_section">
      ...
      <%  } else {    %>
	    <a class="nav-link"  data-target="#DangNhap" href="DangNhap.jsp">Đăng Nhập</a>
  ...
  <!-- shop section -->
   ...
   <section class="shop_section layout_padding">
    <div class="container">
      ...
      <div class="row">
         <%for(Myphambean s: mbo.getmypham()) { %>
            ...
            <a href="">
              <div class="img-box">
                <img src="<%=s.getImg() %>" alt="">
                 <a href="giohang?ms=<%=s.getMamp()%>&ts=<%=s.getTen()%>&gia=<%=s.getGia()%>"> 
              </div>
              <div class="detail-box">
                <h6>
                  <%=s.getTen() %>
      ...
      <div class="row">
        <div class="col-md-6 col-lg-3 footer-col">
          <div class="footer_detail">
            ...
            <p>
             Mỹ phẩm chính hãng hàng đầu Việt Nam Cung cấp mỹ phẩm làm đẹp chính hãng –chất lượng tốt – giá tốt nhất thị trường.
            </p>
